...
export const industries: IndustryPage[] = [
  ...
  },
  {
    ...
    portfolioSlugs: ["rigid-box", "essential-oil-boxes", "honey-box", "coffee-variety-kit"],
    startingMoq: "From 500 units",
    leadTime: "10–15 working days after approval",
    heroImage: "/images/industries/retail.jpg",
    gallery: ["/images/industries/retail.jpg", ...productImages["rigid-box"], ...productImages["essential-oil-boxes"], ...productImages["honey-box"]],
    faqs: [
