...
export const industries: IndustryPage[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: "Minimum order?", answer: "Rigid boxes start from 300 units. They cost more per unit than folding cartons because the board is hand-wrapped, and the per-unit price drops as volume rises." },
    ],
    cta: {
    ...
    seo: {
      ...
      metaDescription:
        "Custom rigid boxes in Pakistan — magnetic closures, foiled logos, soft-touch wraps and fitted inserts. Premium rigid board packaging from 300 units. Get a quote.",
